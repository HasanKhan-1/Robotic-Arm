...
i2c = board.I2C()# Create a simple PCA9685 class instance.
pca = PCA9685(i2c)
...
# servoB = servo.Servo(pca.channels[11])
# servoF = servo.Servo(pca.channels[15])
...
while fraction < 1.0:
    ...
    # servoB.fraction = fraction
    # servoF.fraction = fraction
    fraction += 0.01
    time.sleep(0.03)
